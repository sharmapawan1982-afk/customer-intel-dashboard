...
export default function App() {
  ...
  const analyzeCustomer = async () => {
    ...
    try {
      // Combined search and analysis in one call
      const response = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: 'user',
            content: `Search for the latest news and developments about ${customerName}. Then analyze the information and provide a structured JSON response (respond ONLY with valid JSON, no preamble, no markdown code blocks):

{
  ...
  "opportunities": [
    {
      "area": "ServiceNow product/solution (e.g., ITSM, CSM, HRSD, AI Search, Employee Workflows, IT Operations Management)",
      "insight": "specific opportunity based on the news",
      "reasoning": "why this ServiceNow solution makes sense for this customer based on the news"
    }
  ],
  "keyTakeaway": "One paragraph executive summary of the customer's situation and how ServiceNow could add value"
}

Focus on recent news about: business challenges, digital transformation, technology investments, operational issues, customer experience, IT modernization, regulatory challenges, growth initiatives. Identify 5-7 news items and 3-5 ServiceNow opportunities.`
          }],
          tools: [{
